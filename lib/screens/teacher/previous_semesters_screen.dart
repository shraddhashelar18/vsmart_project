...
class _PreviousSemestersScreenState extends State<PreviousSemestersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final int attendance = semesterData["attendance"];
    final int percentage = semesterData["percentage"];
  ...
  Future<void> _openPdf(String assetPath) async {
    ...
    final file = File('${(await getTemporaryDirectory()).path}/marksheet.pdf');
